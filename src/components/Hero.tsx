        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 py-6 lg:py-12">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-start">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-navy leading-[1.1] mb-6">
              Premium dental care, <span className="text-teal">made simple.</span>
            </h1>

            {/* Supporting Copy */}
            <p className="text-base sm:text-lg text-slate-600 leading-relaxed mb-8 max-w-xl">
              From routine check-ups to cosmetic and restorative dentistry, our experienced team provides personalised dental care in a comfortable, modern environment.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3.5 mb-10 w-full sm:w-auto">
              <button
                ...
                className="group bg-teal text-white px-8 py-4 text-sm font-bold rounded-xl hover:bg-teal/90 transition-all duration-300 inline-flex items-center justify-center gap-2.5 shadow-lg shadow-teal/20"
              >
                <Calendar size={18} />
                Book an Appointment
              ...
              <a
                href="tel:0361000000"
                className="bg-navy text-white px-8 py-4 text-sm font-bold rounded-xl hover:bg-navy-mid transition-all duration-300 inline-flex items-center justify-center gap-2.5 shadow-lg shadow-navy/15"
              >
            ...
            <div className="w-full pt-6 border-t border-slate-200/80">
              <p className="text-[11px] font-bold uppercase tracking-wider text-slate-400 mb-3">Why Hobart Patients Trust Us</p>
            ...
            <div className="relative bg-white rounded-3xl p-3 shadow-2xl border border-slate-200/80 overflow-hidden group">
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3] bg-slate-100">
                <img
                  ...
                  alt="Harbour Dental Studio modern treatment room in Hobart"
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  ...
                  <p className="text-sm font-bold">State-of-the-art dental care with a personal touch.</p>
                </div>
              </div>
              ...
              <div className="absolute -top-4 -right-4 bg-white/95 backdrop-blur-md rounded-2xl shadow-xl border border-slate-200 p-3.5 flex items-center gap-3 animate-float z-20 hidden sm:flex">
                ...
                <div>
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Quality Standard</p>
              ...
              <div className="absolute -bottom-4 -left-4 bg-white/95 backdrop-blur-md rounded-2xl shadow-xl border border-slate-200 p-3.5 flex items-center gap-3 animate-float-delay z-20 hidden sm:flex">
                ...
                <div>
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Patient Comfort</p>
                  <p className="text-xs font-black text-navy">Gentle & Caring Environment</p>
                </div>
              </div>
            </div>
          </div>
